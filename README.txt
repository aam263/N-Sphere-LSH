...
This algorithm provides an implementation of partitioning the unit sphere into regions, and the hash mechanism hashes unit vectors within the same region into the same bucket.
The hash of a unit vector is of the form "[a1,b1][a2,b2]...[an,bn]", where ai and bi are the left and right angular bounds of dimension i.
